...
public slots:
    ...
    void AllMsgsSent(){ m_there_are_msgs_to_send=false;}
    void GetMsgsQueueState(bool state){ m_there_are_msgs_to_send=state;}
...
protected:
    ...
    bool m_there_are_msgs_to_send=false;
